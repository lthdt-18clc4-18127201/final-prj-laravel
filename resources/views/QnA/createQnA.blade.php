        ...
        <div class="content-qna">
            <div class="content-main">
                ...
                <div class="content-title">
                    ...
                    <textarea id="title-text" rows="2" cols="50" class="title hidden" name="title"
                        placeholder="Hãy viết tiêu đề..."></textarea>
                </div>
                <div class="content-split"></div>
                <textarea id="description" rows="4" cols="50" class="content-description" name="description"
                    placeholder="Viết điều bạn muốn chia sẻ."></textarea>
                <div class="content-split"></div>
            </div>
        </div>
    </div>
