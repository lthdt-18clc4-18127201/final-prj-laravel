...
<div class="QnA-container row">
    ...
    <div class="right-side col-8">
        <p class="new-question">
            ...
            <a href="/qna/open-questions" class="btn-goto-answer">Trả lời ngay<i class="fa-solid fa-arrow-right" style="color: #ffffff"></i></a>
        </p>
        <div>
        ...
        <div class="newest-posts">
            <div class="newest-status">
                <button class="newest-status-btn" type="button">
                    <svg width="6" height="6" stroke-width="0" viewBox="0 0 24 24" fill="#45ada6" xmlns="http://www.w3.org/2000/svg" type="solid" class="tw-fill-teal-600"><circle cx="12" cy="12" r="10" fill="inherit"></circle></svg>
                    <span class="newest-status-text">Mới nhất</span>
                </button>
                <button class="less-response-status-btn">
                    <svg width="6" height="6" stroke-width="0" viewBox="0 0 24 24" fill="current" xmlns="http://www.w3.org/2000/svg" type="solid" class="tw-fill-gray-500"><circle cx="12" cy="12" r="10" fill="inherit"></circle></svg>
        ...
        <a href="/newest-posts" class="newest-posts-item">
            <div class="newest-posts-container">
                ...
                <p class="newest-posts-content">
                    Em vừa apply vị trí fresher mobile developer cho một công ty phần mềm và vừa được nhận thông báo interview. Trước đây em có thực tập 3 tháng ở một công ty và làm web + mobile với Vue, Flutter nhưng vì lương fresher fulltime bên đó offer cho em khá thấp nên em đã từ chối. Em muốn hỏi là nếu HR ở cty mới hỏi về lương cty cũ thì em phải trả lời như thế nào ?
                </p>
            </div>
